      ...
      try {
        ...
        if (riderDoc.exists()) {
          ...
          setStatus({
            ...
            pendingDocuments: riderData.pendingDocuments,
            message: riderData.verificationMessage
          });
        }
      } catch (error) {
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold mb-2">
                      {status?.isVerified ? "Account Verified" : "Verification Pending"}
                    </h2>
                    <p className="text-gray-600">
                      {status?.isVerified
                        ? "Your account has been verified. You can now start accepting deliveries."
                        : "Your account is currently under review. We'll notify you once the verification is complete."}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  If you have any questions about your verification status, please contact our support team.
                </p>
                <a
